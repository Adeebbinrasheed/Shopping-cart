...
const SignUp = () => {
  return (
    ...
    <div className="h-[600px] flex flex-col justify-center bg-white m-auto px-14 py-10 rounded-md">
        ...
        <button className="bg-black text-white rounded-lg w-full my-5 py-2">Sign Up</button>
        <p className="font-bold">Already have an accout? <span className="text-blue-500 underline cursor-pointer"><NavLink to="/login">Login</NavLink></span></p>
