    ...
    <>
      <div className="relative bg-bg-hero w-full  h-[700px] bg-center bg-cover pb-12  bg-no-repeat mt-10  ">
        <div className="absolute top-36 px-6 lg:pl-20">
          <div>
            <h1 className="text-5xl md:text-5xl  font-extrabold max-w-[15rem] lg:max-w-[41rem]">
              LET'S <span className="text-gray-500 ">EXPLORE</span> UNIQUE CLOTHES.
            </h1>
            <p className="mt-10 max-w-[33rem] md:text-2xl text-lg font-semibold">
      ...
      >
        <div className="flex items-center justify-center text-3xl font-bold  space-x-20 p-4 text-white  ">
