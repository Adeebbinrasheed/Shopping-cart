        ...
        <div className="flex flex-col gap-y-2">
          ...
          <div className="">
            ...
            <div className="flex flex-col gap-y-3 mb-4 max-w-[555px]">
              <button onClick={()=>{addToCart(product.id)}} className="border-2 uppercase p-2 border-slate-950 tracking-widest">Add to Cart</button>
              <button className="border-2 uppercase p-2 bg-slate-800 text-white tracking-widest">But it now</button>
            </div>
            <p>
