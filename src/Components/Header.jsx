  ...
  return (
    <div className="fixed top-0 right-0 bg-white left-0 flex justify-between items-center p-4 sm:px-8 px-3 border-b-2 shadow-md z-10  ">
      ...
      <Navbar
        containerStyles={`${
          menuopened
            ? "flex flex-col gap-y-20 py-24 bg-gray-300  text-xl   w-72 h-full  fixed top-[73px]  right-0 items-center  transition-all duration-500 bg-slate-100"
            : "flex flex-col gap-y-20 py-24   w-72 h-full fixed top-[73px] -right-[100%] items-center p-12 transition-all duration-500"
        }`}
      />
